    ...
    <section className="flex flex-col tablet:flex-row py-50 laptop:mt-50">
      ...
      <div className="w-full tablet:w-4/6">
        ...
        <p className="text-gray-100 text-12 tablet:text-16 pt-8">
           با برخورداری از صفاتی همچون انعطاف‌پذیری
          در مواجهه با تغییرات، همکاری فعال در تیم و پیشرفت مداوم در مهارت‌های
          فنی و بهبود فرآیندهای کاری، یک فرد همواره آماده برای ایجاد تحول در پروژه‌ها هستم.
        </p>
