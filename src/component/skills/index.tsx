      ...
      >
        <div className="grid gap-12 grid-cols-1 tablet:grid-cols-2 laptop:grid-cols-4">
          <div className="bg-black-300 p-20">
            <div className="ltr">
              ...
              <div className="relative h-[6px] bg-white-100 rounded-4">
                <div className="skill w-[80%] after:content-['80%'] left-0"></div>
              </div>
            </div>
            <div className="pt-40 ltr">
              ...
              <div className="relative h-[6px] bg-white-100 rounded-4">
                <div className="skill w-[40%] after:content-['40%'] left-0"></div>
              </div>
            </div>
            <div className="pt-40 ltr">
              <span className="text-white-100 text-17 flex pb-40 justify-end">
            ...
            <div className="pt-40 ltr">
              ...
              <div className="relative h-[6px] bg-white-100 rounded-4">
                <div className="skill w-[70%] after:content-['70%'] left-0"></div>
              </div>
            </div>
          </div>
          <div className="bg-black-300 p-20">
          ...
          <div className="pt-40 ltr">
              ...
              <div className="relative h-[6px] bg-white-100 rounded-4">
                <div className="skill w-full after:content-['100%'] left-0"></div>
              </div>
            </div>
            <div className="pt-40 ltr">
              <span className="text-white-100 text-17 flex pb-40 justify-end">
            ...
            <div className="pt-40 ltr">
              ...
              <div className="relative h-[6px] bg-white-100 rounded-4">
                <div className="skill w-[90%] after:content-['90%'] left-0"></div>
              </div>
            </div>
          </div>
          <div className="bg-black-300 p-20">
            <div className="ltr">
              ...
              <div className="relative h-[6px] bg-white-100 rounded-4">
                <div className="skill w-[90%] after:content-['90%']"></div>
              </div>
            </div>
            <div className="pt-40 ltr">
              <span className="text-white-100 text-17 flex pb-40 justify-end">
              ...
              <div className="relative h-[6px] bg-white-100 rounded-4">
                <div className="skill w-[85%] after:content-['85%']"></div>
              </div>
            </div>
            <div className="pt-40 ltr">
              <span className="text-white-100 text-17 flex pb-40 justify-end">
          ...
          <div className="ltr">
              ...
              <div className="relative h-[6px] bg-white-100 rounded-4">
                <div className="skill w-full after:content-['100%']"></div>
              </div>
            </div>
            <div className="pt-40 ltr">
              <span className="text-white-100 text-17 flex pb-40 justify-end">
